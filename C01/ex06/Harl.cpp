...
{
	std::string	str;
	str = "I love having extra bacon for my 7XL-double-cheese-triple-pickle-specialketchup burger. I really do!";
...
{
	std::string	str;
	str = "I cannot believe adding extra bacon costs more money.";
...
{
	std::string	str;
	str = "I think I deserve to have some extra bacon for free.";
